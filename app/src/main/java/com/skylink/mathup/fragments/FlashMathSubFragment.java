...
import com.skylink.mathup.FlashMainSubActivity;
...
public class FlashMathSubFragment extends Fragment {
    Button flash;
    Context mContext;
    TextView titleSub;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        titleSub.setText(getString(R.string.subtraction));

        cardLayout.setBackground(ContextCompat.getDrawable(mContext,R.drawable.curve_bg_green));
        ...
        flash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                assert getActivity() != null;
                startActivity(new Intent(getActivity(), FlashMainSubActivity.class));
                //getActivity().finish();
            }
        });
