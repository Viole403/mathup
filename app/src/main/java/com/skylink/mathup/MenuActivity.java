...
import com.skylink.mathup.fragments.FlashMathAdditionFragment;
import com.skylink.mathup.fragments.FlashMathMultiplyFragment;
import com.skylink.mathup.fragments.FlashMathSubFragment;
import com.skylink.mathup.fragments.PracticeMultiplicationTableFragment;
import com.skylink.mathup.fragments.TrueOrFalseAddFragment;
import com.skylink.mathup.fragments.TrueOrFalseMultiplicationFragment;
import com.skylink.mathup.fragments.TrueOrFalseSubFragment;
...
//    AdView adB;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        showOnce = myPreferences.getShowOnce();

        //Background sound
        musicPlay = MediaPlayer.create(this, R.raw.bg_music1);
        ...
        //add Fragments
        pagerAdapter.addFragment(new FlashMathMultiplyFragment());
        pagerAdapter.addFragment(new TrueOrFalseMultiplicationFragment());
        pagerAdapter.addFragment(new PracticeMultiplicationTableFragment());
        pagerAdapter.addFragment(new FlashMathAdditionFragment());
        pagerAdapter.addFragment(new TrueOrFalseAddFragment());
        pagerAdapter.addFragment(new FlashMathSubFragment());
        pagerAdapter.addFragment(new TrueOrFalseSubFragment());
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            constraintLayout.setBackground(ContextCompat.getDrawable(getApplicationContext(), R.drawable.background_anim_yellow)); }
