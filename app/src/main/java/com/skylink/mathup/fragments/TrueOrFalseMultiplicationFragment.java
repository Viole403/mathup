...
import com.skylink.mathup.TrueOrFalseMultiplyActivity;
...
public class TrueOrFalseMultiplicationFragment extends Fragment {
    Context mContext;
    Button start;
    ...
    public TrueOrFalseMultiplicationFragment() {
    }
    @Nullable
    @Override
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                assert getActivity() != null;
                startActivity(new Intent(getActivity(), TrueOrFalseMultiplyActivity.class));
                //getActivity().finish();
            }
        });
