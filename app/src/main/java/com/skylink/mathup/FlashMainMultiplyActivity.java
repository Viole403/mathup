...
public class FlashMainMultiplyActivity extends AppCompatActivity{
...
//        loadAd();
        ...
        scoreFlashMultiply = myPreferences.getFlashMultiplyScore();
        levelFlashMultiply = myPreferences.getFlashMathMultiplyLevel();
        ...
        timerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog timerDialog = new Dialog(FlashMainMultiplyActivity.this,  R.style.dialogWidth_100);
    ...
    private void generateMultiplication(){
        ...
        if (scoreFlashMultiply <= 10) {
            ...
            cNumA = 2;
            cNumB = rd.nextInt(9) + 1;
            cAns = cNumA * cNumB;
            wNum1 = 2;
            wNum2 = rd2.nextInt(9) + 1;
            wNum3 = 2;
            wNum4 = rd3.nextInt(9) + 1;
            ...
            cNumA = 12;
            cNumB = rd.nextInt(10) + 1;
            cAns = cNumA * cNumB;
            wNum1 = 12;
            wNum2 = rd2.nextInt(10) + 1;
            wNum3 = 12;
            wNum4 = rd3.nextInt(10) + 1;
            ...
            cNumA = rd.nextInt(11) + 1;
            cNumB = rd2.nextInt(11) + 1;
            wNum1 = rd3.nextInt(11) + 1;
            wNum2 = rd4.nextInt(11) + 1;
            wNum3 = rd5.nextInt(11) + 1;
            wNum4 = rd6.nextInt(11) + 1;
            ...
            } else if (scoreFlashMore % 10 == 1 && myPreferences.getTempForLevel() == 0){
                myPreferences.setTempForLevel(1);
        ...
        if (cNumB == wNum2 || cNumB == wNum4 || wNum2 == wNum4){
        ...
        myPreferences.setFlashMathMultiplyLevel(levelFlashMultiply);
    ...
    private void levelProgress() {
        int progressInt = 0;
        int progressSaved = myPreferences.getFlashMultiplyProgress();
    ...
    private void showLevelUp(){
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myPreferences.setShowLevelUp(0);
                startActivity(new Intent(getApplicationContext(), FlashMainMultiplyActivity.class));
                finish();
            }
        });
...
//            showIntAd();
    ...
    private void FlashQuiz(){
        ...
        wrongFlashMultiply = myPreferences.getFlashMultiplyWrongScore();
    ...
    private void generateCards(){
        cEquation = cNumA + " x " + cNumB;
        wEquation1 = wNum1 + " x " + wNum2;
        wEquation2 = wNum3 + " x " + wNum4;
    ...
    private void checkAnswer(String toCheckString, RelativeLayout layout){
        ...
        if (toCheckString.equals(cEquation) && layout.getId() == choiceA.getId()) {
            ...
            levelProgressUp();
            myPreferences.setTempForLevel(0);
            myPreferences.setShowLevelUp(1);
        }else
        ...
        myPreferences.setFlashMultiplyScore(scoreFlashMultiply);
        myPreferences.setFlashMultiplyWrongScore(wrongFlashMultiply);
        progressBarQuiz.setProgress(100);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    private void levelProgressUp(){
        ...
        if (myPreferences.getFlashMultiplyProgress() < 10){
            myPreferences.setFlashMultiplyProgress(
                    myPreferences.getFlashMultiplyProgress() + 1);
        } else {
            myPreferences.setFlashMultiplyProgress(1);
        }
...
//                    });
//
//                    mInterstitialAd.show(FlashMainMultiplyActivity.this);
//                }
//
