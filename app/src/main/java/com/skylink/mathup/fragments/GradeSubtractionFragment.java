...
public class GradeSubtractionFragment extends Fragment {
    Context mContext;
    ...
    public GradeSubtractionFragment() {
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        title.setText(getString(R.string.subtraction));

        String flashScoreString = myPreferences.getFlashMathSUBCorrectScoreInt() + " / "
                + (myPreferences.getFlashMathSUBCorrectScoreInt() + myPreferences.getFlashMathSUBWrongScoreInt());
        flashScore.setText(flashScoreString);

        String tofScoreString = myPreferences.getTrueOrFalseSUBScoreInt() + " / "
                + (myPreferences.getTrueOrFalseSUBScoreInt() + myPreferences.getTrueOrFalseSUBWrongScoreInt());
    ...
    private void confirmation(){
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myPreferences.setFlashMathSUBCorrectScoreInt(0);
                myPreferences.setFlashMathSUBWrongScoreInt(0);
                myPreferences.setFlashMathSUBLevel(1);
                myPreferences.setFlashMathSUBLevelProgress(0);
                myPreferences.setTrueOrFalseSUBScoreInt(0);
                myPreferences.setTrueOrFalseSUBWrongScoreInt(0);
                myPreferences.setTrueOrFalseSUBLevel(1);
                myPreferences.setTrueOrFalseSUBLevelProgress(0);
