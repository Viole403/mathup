...
public class TrueOrFalseSubActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        scoreTF = myPreferences.getTrueOrFalseSUBScoreInt();
        levelTF = myPreferences.getTrueOrFalseSUBLevel();
    ...
    private void generateTrueMultiplication(){
        ...
        if (scoreTF <= 10) {
            ...
            if (scoreTF <= 120) {
                ...
                num1 = rd.nextInt(24) + 12;
                num2 = rd2.nextInt(11) + 1;
            } else {
                num1 = rd.nextInt(25) + 25;
                num2 = rd2.nextInt(24) + 1;
            ...
            myPreferences.setTrueOrFalseSUBLevel(levelTF);
    }
    ...
    private void checkAnswer(LinearLayout button){
        ...
        if (numAnswer == num1 -  num2) {
            ...
            if(button.getId() == R.id.trueButton){
                ...
                scoreTF = scoreTF + 1;
                myPreferences.setTrueOrFalseSUBScoreInt(scoreTF);
                levelProgressUp();
    ...
    private void levelProgress() {
        ...
        int progressInt = 0;
        int progressSaved = myPreferences.getTrueOrFalseSUBLevelProgress();
    ...
    private void levelProgressUp(){
        ...
        if (myPreferences.getTrueOrFalseSUBLevelProgress() < 10){
            myPreferences.setTrueOrFalseSUBLevelProgress(
                    myPreferences.getTrueOrFalseSUBLevelProgress() + 1);
        } else {
            myPreferences.setTrueOrFalseSUBLevelProgress(1);
        }
